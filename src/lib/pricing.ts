 ...
 *
 * ⚠ БАГЦ БИШ ХОЁР МӨР: «1 удаа» ба «Шүүгээ» нь `packages` хүснэгтэд
...
const DAY_PASS: BoardRow = {
  key: 'static-day',
  // «1 өдөр» биш «1 удаа»: заал өдөрт нэг удаа орохыг зөвшөөрдөг тул
  // хэмжих нэгж нь хоног биш ОРОЛТ. «1 өдөр» гэвэл өдөржин байж
  // болох мэт ойлгогдоно.
  name: '1 удаа',
  price: 30_000,
  basePrice: null,
  notes: [],
