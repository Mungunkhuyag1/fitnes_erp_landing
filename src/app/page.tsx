        ...
        <section className={hero ? 'wf-hero wf-hero--photo' : 'wf-hero'}>
          ...
          <div className="wf-hero-body">
            <div>
              ...
              {/*
                ⚠ Доорх ногоон тууз нь тоног төхөөрөмж, сауна, шүршүүр,
                зогсоолыг ЖАГСААНА. Энд тэр жагсаалтыг давтахгүй —
                ямар ОРЧИН болохыг хэлнэ.
              */}
              <p className="wf-lede">
                {GYM.city} хотын фитнес клуб. Тохилог тухтай орчин,
                бүрэн тоноглогдсон заал, дасгалын дараа сауна.
              </p>
            </div>
